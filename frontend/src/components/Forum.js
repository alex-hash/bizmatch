          ...
          <div className="w-auto border-gray-200 border-2 mx-2 bg-white md:w-2/3 rounded mb-4 md:mt-20">
            ...
            <div>
              <p className="mb-2 text-xs lg:text-sm px-2">
                Ostia es bastante dificil de responder. Pero yo juraria que @Manolo te podría ayudar. Él es muy bueno
                haciendo y resolviendo dudas sobre estas cosas
              </p>

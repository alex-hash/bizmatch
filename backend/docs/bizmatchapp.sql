...
-- -----------------------------------------------------
-- Table `bizmatchapp`.`comment_assesment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bizmatchapp`.`comment_assesment` ;

CREATE TABLE IF NOT EXISTS `bizmatchapp`.`comment_assesment` (
  `id` CHAR(36) NOT NULL,
  `type` INT(1) NOT NULL,
  `created_at` DATETIME NOT NULL,
  ...
  `user_id` CHAR(36) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_comment_assesment_comment1_idx` (`comment_id` ASC),
  INDEX `fk_comment_assesment_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_comment_assesment_comment1`
    FOREIGN KEY (`comment_id`)
    REFERENCES `bizmatchapp`.`comment` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_comment_assesment_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `bizmatchapp`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
